	...
	<div class="login">
		<h4 class="login_title">
			 ...
			 <div v-if="loginway==='login'">
				 	...
				 	<div class="input_div">
					 	<input type="text" placeholder="手机号或邮件箱" class="input_top input_normal" v-model="userName">
					</div>
				 	<div class="input_div">
				 		<input type="password" placeholder="密码" class="input_bottom input_normal" v-model="passWord">
				 	</div>
				 	<div class="forget">
				 		<span>忘记密码？</span>
				 	</div>
